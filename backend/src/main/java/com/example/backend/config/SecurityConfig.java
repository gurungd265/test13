...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://127.0.0.1:5174","https://calmarketon-7b4mnr3ki-gurungd265s-projects.vercel.app","https://calmarketon.vercel.app")); // React/Vite 개발 서버 주소
